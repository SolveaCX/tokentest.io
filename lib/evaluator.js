...
function scorePublicBenchmarkCases(probes) {
  ...
  return {
    ...
    reasoning_counterfactual: [
      ...
      }, { partial: counterfactualPartial, partialDetail: "length-limited counterfactual reasoning was incomplete" }),
    ],
...
function advancedReasoningCategory(key, name, probe, ok, passDetail, failDetail, meta, options = {}) {
  ...
  return category(key, name, ok ? "pass" : partial ? "partial" : "fail", ok ? 100 : partial ? 60 : 25, 100, ["reasoning/advanced"], ok ? passDetail : filtered ? "provider content_filter returned empty content for this advanced reasoning probe" : options.partialDetail || failDetail, partial ? "p2" : "p1", { ...meta, ...(partial ? weakReminder() : {}) });
}
