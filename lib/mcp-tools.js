...
export async function assertRemoteBaseUrlAllowed(baseUrl, { allowPrivate = false, respectEnv = true } = {}) {
  if (allowPrivate || (respectEnv && /^(1|true|yes|on)$/i.test(String(process.env.MCP_ALLOW_PRIVATE_BASE_URLS || "")))) return;
